...
//  GHFollowers
//
//  Created by Matthew Rodriguez on 1/20/25.
//
...
enum PersistenceManager {
    ...
    static func updateWith(
        favorite: Follower, actionType: PersistenceActionType,
    ...
    static func retrieveFavorites(
        ...
        guard
            let favoritesData = defaults.object(forKey: Keys.favorites) as? Data
        else {
            completion(.success([]))
            return
        }
